          ...
          { !this.state.hasSignedUp &&
            <div className="w-full block flex flex-wrap">
              ...
              <div className="flex w-full mr-4">
                <input type="email" id="email" value={ email } required="required" onChange={this.handleChange} name="email" className="text-xs max-w-1/2  uppercase font-sans bg-white text-link font-bold tracking-wide px-4 mr-4 flex-1"/>
