      ...
      return (
        <div className="bg-blacker py-6 fixed w-full pin-b text-white flex items-center">
          <div className="max-w-lg mx-auto w-full px-4 sm:px-0">
            <p className="mb-0 pr-12 sm:pr-0">I have an opening for new work in August 2019. <Link className="text-white" to="/contact">Get in touch</Link> now to secure your slot.</p>
          </div>
