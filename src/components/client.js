        ...
        <div className="w-full flex items-center justify-center h-full bg-white relative">
          ...
          { this.props.case &&
            <span className="w-full flex items-center justify-center flex-wrap h-full bg-white relative">
              ...
              <Link to={ this.props.case } className="case-link w-full absolute pin-b pb-4 text-xs uppercase tracking-wide font-bold text-center link invisible sm:visible">View case →</Link>
            </span>
          }
        </div>
      </div>
