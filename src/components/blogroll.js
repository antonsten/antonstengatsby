...
export default () => (
      ...
      <div className="w-full">
        <div className="sm:-mx-16 mb-16">
          ...
          <div className="sm:flex w-full bg-grey-lightest p-8 sm:p-16 sm:pb-6 text-black">
            ...
            <div className="w-full sm:w-2/3 text-base sm:text-lg font-serif leading-tight">
          ...
          <div className="sm:flex w-full bg-grey-lightest p-8 sm:p-16 text-black">
            ...
            <div className="w-full sm:w-2/3 text-base sm:text-lg font-serif leading-tight mb-6 sm:mb-12">
  ...
  <div className="w-full pb-12">
    <div className="sm:flex w-full items-center py-4">
      ...
      <div className="w-full sm:w-2/3">
        <Link className="font-serif leading-tight text-black" to="/newsletter">
        ...
        if(tag === 'newsletter') {
          return (
            <div className="sm:flex w-full items-center py-4" key={i}>
              ...
              <div className="w-full sm:w-2/3">
                <Link className="relative font-serif leading-tight no-underline text-black" to={node.fields.slug}>
                  {title}
                </Link>
              </div>
            </div>
