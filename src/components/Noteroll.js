                  ...
                  <div className="w-full bg-grey-lightest p-8 sm:p-16 mt-12 mb-16 flex flex-wrap">
                    <div className="w-full sm:w-1/3">
                      ...
                      <div className="flex justify-left">
                        <a href={`https://twitter.com/intent/tweet/?text=${title}&url=https://www.antonsten.com${pathName}&via=antonsten`} className="flex relative items-center no-underline mr-2 hover-border-none border-none cursor-pointer">
                          <img className="w-8" src="/images/twitter-svg.svg" alt="Twitter"></img>
                        </a>
                        <a href={`https://www.linkedin.com/shareArticle?mini=true&url=https://www.antonsten.com${pathName}&title=${title}&source=${title}`}target="_blank" rel="noopener noreferrer" className="flex relative no-underline items-center mx-2 hover-border-none border-none cursor-pointer">
