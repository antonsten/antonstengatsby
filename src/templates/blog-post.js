    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <article>
          ...
          <div className="w-full border-t border-b border-grey-lighter mt-8 mb-5">
            <div className="flex justify-center items-center my-3">
              <a href={`https://twitter.com/intent/tweet/?text=${post.frontmatter.title}&url=https://www.antonsten.com${pathName}&via=antonsten`}target="_blank" className="flex items-center mx-2 hover-border-none border-none cursor-pointer">
